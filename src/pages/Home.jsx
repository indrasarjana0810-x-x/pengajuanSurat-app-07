  ...
  return (
    <div className="hero-section">
      ...
      <p>
        ...
        Mulai pengajuan, lacak status, hingga kelola persetujuan, semua dalam satu platform yang transparan dan efisien.
      </p>
      ...
      <div className="home-grid">
        <Link to="/buat" className="action-card card-buat">
          ...
          <p>Ajukan surat permohonan, izin, atau keterangan dengan cepat dan mudah melalui formulir digital.</p>
        </Link>
        
        <Link to="/riwayat" className="action-card card-riwayat">
          <div className="card-icon">{icons.Riwayat}</div>
          <h3>Riwayat Pengajuan</h3>
          <p>Lacak status semua surat yang telah Anda kirim secara real-time dengan detail lengkap.</p>
        </Link>
        
        <Link to="/approval" className="action-card card-approval">
          <div className="card-icon">{icons.Approval}</div>
          <h3>Halaman Approval</h3>
          <p>Khusus untuk approver: Tinjau, setujui, atau tolak permintaan surat dengan mudah.</p>
        </Link>
      </div>
    </div>
  )
